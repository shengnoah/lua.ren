...
categories: [topic]
---
lua是一门轻量级的脚本语言…好像比较适合写游戏？在 [太阳神三国杀](https://github.com/Mogara/QSanguosha)
中见过很多lua脚本。 由于[splash](https://splash.readthedocs.io/en/stable/scripting-
tutorial.html) 的渲染脚本需要用lua来写，因此来学习一波。
...
![](https://111qqz.github.io//img/reward/wechat-2.png)

![](https://111qqz.github.io//img/reward/wechat-btn.png)
![](https://111qqz.github.io//img/reward/alipay-btn.png)
